...
class OrderDetail extends React.Component{
    ...
    render(){
        ...
        console.log(this.state.orderInfo.orderNo);
        console.log(this.state.orderInfo.orderNo);
        console.log(this.state.orderInfo.receiverName || []);
        let receiverInfo = this.state.orderInfo.addressVo   || {},
            productList  = this.state.orderInfo.orderItemVoList || []; /*没有就是空的数组*/
        let tableHeads = [
            {name: '商品图片', width: '10%'},
            {name: '商品信息', width: '45%'},
            {name: '单价', width: '15%'},
                ...
                <div className="form-horizontal">
                   ...
                   {/* <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <div className="col-md-5">
                            <p className="form-control-static">
                                {this.state.orderInfo.receiverMobile || this.state.orderInfo.receiverPhone}
                            </p>
                        </div>
                    </div>*/}
                    ...
                    <div className="form-group">
                        <label className="col-md-2 control-label">总额</label>
                        <div className="col-md-5">
                            <p className="form-control-static">
